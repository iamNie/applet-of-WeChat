      ...
      success: function (res) {
        if (res.data.respCode == '000000') {
          for (var index in res.data.infos) {
            ...
            res.data.infos[index].total_nav = util.toFixNumber(res.data.infos[index].total_nav, 4);//累计净值格式化
            res.data.infos[index].avgreturn_day = util.toFixNumber(res.data.infos[index].avgreturn_day, 2);//日涨幅格式化
